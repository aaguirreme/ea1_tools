...
0 & 5 & -6 & 3
\end{array}\end{bmatrix}\stackrel{-\nicefrac{1}{2}{\color{red}R}_{{\color{red}2}}}{\Rightarrow}\begin{bmatrix}\begin{array}{rrr|r}
1 & -1 & 1 & 0\\
0 & 1 & -1 & 1\\
0 & 5 & -6 & 3
\end{array}\end{bmatrix}
...
\end{array}\end{bmatrix}\stackrel{-5{\color{blue}R_{2}}+{\color{red}R_{3}}}{\Rightarrow}\begin{bmatrix}\begin{array}{rrr|r}
1 & -1 & 1 & 0\\
{\color{blue}0} & {\color{blue}1} & {\color{blue}-1} & {\color{blue}1}\\
0 & 0 & -1 & -2
\end{array}\end{bmatrix}
...
\end{array}\end{bmatrix}\overset{-1{\color{red}R_{3}}}{\Rightarrow}\begin{bmatrix}\begin{array}{rrr|r}
1 & -1 & 1 & 0\\
0 & 1 & -1 & 1\\
0 & 0 & 1 & 2
\end{array}\end{bmatrix}
...
\end{array}\end{bmatrix}\stackrel{{\color{blue}R_{3}}+{\color{red}R_{2}}}{\Rightarrow}\begin{bmatrix}\begin{array}{rrr|r}
1 & -1 & 1 & 0\\
0 & 1 & 0 & 3\\
{\color{blue}0} & {\color{blue}0} & {\color{blue}1} & {\color{blue}2}
\end{array}\end{bmatrix}
...
0 & 1 & 0 & 3\\
{\color{blue}0} & {\color{blue}0} & {\color{blue}1} & {\color{blue}2}
\end{array}\end{bmatrix}\stackrel{-{\color{blue}R_{3}}+{\color{red}R_{1}}}{\Rightarrow}\begin{bmatrix}\begin{array}{rrr|r}
1 & -1 & 0 & -2\\
0 & 1 & 0 & 3\\
{\color{blue}0} & {\color{blue}0} & {\color{blue}1} & {\color{blue}2}
\end{array}\end{bmatrix}
...
0 & 0 & 1 & 2
\end{array}\end{bmatrix}\stackrel{{\color{blue}R_{2}}+{\color{red}R_{1}}}{\Rightarrow}\begin{bmatrix}\begin{array}{rrr|r}
1 & 0 & 0 & 1\\
{\color{blue}0} & {\color{blue}1} & {\color{blue}0} & {\color{blue}3}\\
0 & 0 & 1 & 2
\end{array}\end{bmatrix}
